var Greenlet = (function () {
	 ...
	 */
	var loader = '<svg id="greenlet-loader" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50"><g id="loader-parts"><circle class="loader-ring" cx="25" cy="25" r="22" /><circle class="loader-c" cx="25" cy="25" r="22" /></g></svg>';
	/**
	...
	function loadPage(obj, cur_page, add, act) {
	  ...
	  xhr.onload = function () {
	    ...
	    if (xhr.readyState === 4 && xhr.status === 200) {
	      ...
	      Greenlet._listeners.forEach(function (fn) {
	        return fn();
	      });
	...
	function jsonToFormData(body) {
	  return Object.keys(body).map(function (key) {
	    return Array.isArray(body[key]) ? body[key].map(function (value) {
	      return key + '=' + encodeURIComponent(value);
	    }).join('&') : key + '=' + encodeURIComponent(body[key]);
	  }).join('&');
	}
	/**
	...
	function fixMenu() {
	  ...
	  var fixToggle = function fixToggle() {
