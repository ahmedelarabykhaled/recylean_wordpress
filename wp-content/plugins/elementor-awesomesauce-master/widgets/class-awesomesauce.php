...
class Awesomesauce extends Widget_Base {
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'custom_content',
			array(
				'label'   => __( 'Custom Content', 'elementor-awesomesauce' ),
				'type'    => Controls_Manager::WYSIWYG,
				'default' => __( 'Custom Content', 'elementor-awesomesauce' ),
			)
		);
        ...
        $this->add_control(
            'custom_image',
            array(
                'label'   => __( 'Custom Image', 'elementor-awesomesauce' ),
                'type'    => Controls_Manager::MEDIA,
                'default' => __( 'Custom Image', 'elementor-awesomesauce' ),
            )
        );
	...
	protected function render() {
		...
		$this->add_inline_editing_attributes( 'custom_content', 'advanced' );
		$this->add_inline_editing_attributes( 'custom_image', 'advanced' );
		?>
		...
		<div <?php echo $this->get_render_attribute_string( 'custom_content' ); ?><?php echo wp_kses( $settings['custom_content'], array() ); ?></div>
		<div <?php echo $this->get_render_attribute_string( 'custom_image' ); ?><?php echo wp_kses( $settings['custom_content'], array() ); ?></div>
		<?php
	}
